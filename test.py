...
print(segment_api('81 Duong 16, P. Binh Tri Dong B, Q.Binh Tan, 0909218877, Dinh Thi Bich Phuong'))
...
print(segment_api('Nguyen Thi Thanh Thuy, 36/6B Quang Trung, P.10, Q. Go Vap, 0958064086'))

# http://localhost:8888/?addText=D002%20Lo%20D%20Chung%20Cu%20KCN%20P.Tay%20Thanh%2C%20Pham%20Thi%20Phuong%2C%200903030818
print(segment_api('D002 Lo D Chung Cu KCN P.Tay Thanh, Pham Thi Phuong, 0903030818'))
